...
sys.path.append("/MachineLearning/Randomized Optimization/jtay6 p2 clean/ABAGAIL/ABAGAIL.jar")
...
for N in nlist:
	...
	# SA
	if 'SA' in algolist:
		# cerange = [0.15,0.35,0.55,0.75,0.95]
		cerange = [0.55]
		for t in range(numTrials):
			for CE in cerange:
